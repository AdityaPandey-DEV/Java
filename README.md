...
**Solution:** [CommandLineInput.java](https://github.com/yourusername/java-programming-lab/blob/main/CommandLineInput.java)
...
**Solution:** [BankDepositCalculator.java](https://github.com/yourusername/java-programming-lab/blob/main/BankDepositCalculator.java)
...
**Solution:** [FriendlyPairChecker.java](https://github.com/yourusername/java-programming-lab/blob/main/FriendlyPairChecker.java)

### 4. Replace Zeros with Ones
**Question:** Program to replace all 0's with 1 in a given integer.

**Solution:** [ReplaceZerosWithOnes.java](https://github.com/yourusername/java-programming-lab/blob/main/ReplaceZerosWithOnes.java)

### 5. ZigZag Array
**Question:** Printing an array into Zigzag fashion where the converted array should be in the form of e1 < e2 > e3 < e4 > e5 < e6.

**Solution:** [ZigZagArray.java](https://github.com/yourusername/java-programming-lab/blob/main/ZigZagArray.java)
...
**Solution:** [RearrangePositiveNegative.java](https://github.com/yourusername/java-programming-lab/blob/main/RearrangePositiveNegative.java)
...
**Solution:** [SaddlePointFinder.java](https://github.com/yourusername/java-programming-lab/blob/main/SaddlePointFinder.java)
...
**Solution:** [BinaryPatternFinder.java](https://github.com/yourusername/java-programming-lab/blob/main/BinaryPatternFinder.java)
...
**Solution:** [Bank.java](https://github.com/yourusername/java-programming-lab/blob/main/Bank.java)
...
**Solution:** [WordExample.java](https://github.com/yourusername/java-programming-lab/blob/main/WordExample.java)
...
**Solution:** [ArrayDemo.java](https://github.com/yourusername/java-programming-lab/blob/main/ArrayDemo.java)
...
**Solution:** [ShapeArea.java](https://github.com/yourusername/java-programming-lab/blob/main/ShapeArea.java)
...
**Solution:** [TemperatureConverter.java](https://github.com/yourusername/java-programming-lab/blob/main/TemperatureConverter.java)
...
**Solution:** [VolumeCalculator.java](https://github.com/yourusername/java-programming-lab/blob/main/VolumeCalculator.java)
...
**Solution:** 
- [Student.java (student package)](https://github.com/yourusername/java-programming-lab/blob/main/student/Student.java)
- [Course.java (course package)](https://github.com/yourusername/java-programming-lab/blob/main/course/Course.java)
- [Enrollment.java (enrollment package)](https://github.com/yourusername/java-programming-lab/blob/main/enrollment/Enrollment.java)
- [StudentManagementSystem.java](https://github.com/yourusername/java-programming-lab/blob/main/StudentManagementSystem.java)
...
**Solution:** [EmployeeValidator.java](https://github.com/yourusername/java-programming-lab/blob/main/EmployeeValidator.java)
...
**Solution:** [MyCalculator.java](https://github.com/yourusername/java-programming-lab/blob/main/MyCalculator.java)
...
**Solution:** [PalindromeCounter.java](https://github.com/yourusername/java-programming-lab/blob/main/PalindromeCounter.java)
...
**Solution:** [MultiThreads.java](https://github.com/yourusername/java-programming-lab/blob/main/MultiThreads.java)
...
**Solution:** [ProducerConsumer.java](https://github.com/yourusername/java-programming-lab/blob/main/ProducerConsumer.java)
...
**Solution:** [RemoveEvenLength.java](https://github.com/yourusername/java-programming-lab/blob/main/RemoveEvenLength.java)
...
**Solution:** [SwapPairs.java](https://github.com/yourusername/java-programming-lab/blob/main/SwapPairs.java)
...
**Solution:** [AlternateLists.java](https://github.com/yourusername/java-programming-lab/blob/main/AlternateLists.java)
...
**Solution:** [VowelCounterGUI.java](https://github.com/yourusername/java-programming-lab/blob/main/VowelCounterGUI.java)
...
**Solution:** [MovieTicketBookingSystem.java](https://github.com/yourusername/java-programming-lab/blob/main/MovieTicketBookingSystem.java)
...
- For GUI applications (Swing or JavaFX), make sure you have the appropriate libraries installed.
- For JavaFX applications, you might need to set up JavaFX SDK separately depending on your Java version.
- Some programs require additional files (like "myfile.txt" for the palindrome counter program). #   J a v a  
 